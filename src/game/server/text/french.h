	...
	"Le Mort-vivant arrive !",
	"Le Mort-vivant est finalement mort",
	...
	"Vous êtes un infecté : Smoker",
	"Vous êtes un infecté : Boomer",
	"Vous êtes un infecté : Hunter",
	"Vous êtes un infecté : Mort-vivant",
	"Vous êtes un infecté : Sorcière",
