...
class CBinds : public CComponent
{
	...
	static bool ConBind(IConsole::IResult *pResult, void *pUserData);
	static bool ConUnbind(IConsole::IResult *pResult, void *pUserData);
	static bool ConUnbindAll(IConsole::IResult *pResult, void *pUserData);
	static bool ConDumpBinds(IConsole::IResult *pResult, void *pUserData);
