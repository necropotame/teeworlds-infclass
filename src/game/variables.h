...
MACRO_CONFIG_STR(SvMaprotation, sv_maprotation, 768, " infc_lunaroutpost infc_skull infc_warehouse infc_sewers infc_damascus infc_eidalfitr infc_provence infc_newdust infc_normandie infc_junglewell", CFGFLAG_SERVER, "Maps to rotate between")
