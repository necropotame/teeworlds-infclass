...
MACRO_CONFIG_STR(SvMaprotation, sv_maprotation, 768, "infc_lunaroutpost infc_newdust infc_warehouse infc_provence infc_damascus infc_eidalfitr infc_sewers infc_skull infc_normandie", CFGFLAG_SERVER, "Maps to rotate between")
