...
MACRO_CONFIG_STR(SvMaprotation, sv_maprotation, 768, "infc_damascus infc_warehouse infc_newdust infc_skull infc_bamboo infc_eidalfitr", CFGFLAG_SERVER, "Maps to rotate between")
