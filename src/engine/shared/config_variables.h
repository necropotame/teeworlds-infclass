...
MACRO_CONFIG_INT(InfMedicLimit, inf_medic_limit, 4, 0, 16, CFGFLAG_SERVER, "Maximum number of medics in game")
MACRO_CONFIG_INT(InfHeroLimit, inf_hero_limit, 3, 0, 16, CFGFLAG_SERVER, "Maximum number of heros in game")
