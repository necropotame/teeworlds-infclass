...
MACRO_CONFIG_INT(SvRconTokenCheck, sv_rcon_token_check, 1, 0, 1, CFGFLAG_SERVER, "Force the use of DDNet-like clients to access to the console")
...
MACRO_CONFIG_INT(InfAccusationThreshold, inf_accusation_threshold, 4, 0, 8, CFGFLAG_SERVER, "Number of accusation needed to start a banvote")
...
MACRO_CONFIG_INT(InfDefenderLimit, inf_defender_limit, 10, 0, 16, CFGFLAG_SERVER, "Maximum number of defenders in game")
...
MACRO_CONFIG_INT(InfMercBombs, inf_merc_bombs, 15, 1, 100, CFGFLAG_SERVER, "Number of bombs for the mercenary")
...
MACRO_CONFIG_INT(InfGhoulThreshold, inf_ghoul_threshold, 5, 0, 10000, CFGFLAG_SERVER, "Ghouls will only be created when number of infected reaches threshold")
