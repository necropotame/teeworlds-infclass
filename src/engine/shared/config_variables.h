...
MACRO_CONFIG_INT(InfBarrierTimeReduce, inf_barrier_timereduce, 100, 0, 10000, CFGFLAG_SERVER, "Time to remove from a barrier lifespan when an infected die (millisec)")
