...
//SuperWeapons
MACRO_CONFIG_INT(InfWhiteHoleMinimalKills, inf_white_hole_minimal_kills, 6, 0, 30, CFGFLAG_SERVER, "Minimal number of kills before super weapons become available")
...
MACRO_CONFIG_INT(InfWhiteHoleNumParticles, inf_white_hole_num_particles, 330, 50, 800, CFGFLAG_SERVER, "Number of particles that will be used for a white hole animation")
