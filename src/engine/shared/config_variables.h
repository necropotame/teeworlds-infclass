...
MACRO_CONFIG_INT(InfBirdAirjumpLimit, inf_bird_airjump_limit, 10000, 0, 10000, CFGFLAG_SERVER, "Max number of extra airjumps")
MACRO_CONFIG_INT(InfBirdDamage, inf_bird_damage, 3, 0, 10000, CFGFLAG_SERVER, "Damage taken by bird's hammer")
...
MACRO_CONFIG_INT(InfProbaBird, inf_proba_bird, 4, 0, 100, CFGFLAG_SERVER, "Probability for an infected to be a bird")
